/* ============================================================================
   app.js — screen navigation + form/tab wiring
   Talks only to BayanihanAPI (see !js/api.js). Swap that file's internals for
   a real backend later and nothing here needs to change.

   NOTE: The markup this file wires up is no longer all in index.html — it's
   split across !opening, !others, !home, !emergencies, !maps, !guide,
   !profile and !report, and gets assembled into the page by !js/loader.js.
   That's why this file exposes window.initApp() instead of running
   immediately: loader.js calls it only after every partial has been
